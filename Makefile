...
K_SRCS = kernel.c memory.c pcb.c traps.c list.c sync.c syscalls.c load_program.c context_switch.c
K_INCS = kernel.h memory.h pcb.h traps.h list.h sync.h syscalls.h load_program.h context_switch.h
