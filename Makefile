...
K_SRCS = kernel.c memory.c pcb.c traps.c list.c sync.c syscalls.c context_switch.c
K_INCS = kernel.h memory.h pcb.h traps.h list.h sync.h syscalls.h context_switch.h
